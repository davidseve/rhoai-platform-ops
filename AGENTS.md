...
- **Auth:** Kuadrant AuthPolicy with KubernetesTokenReview (RHOAI 3.4+) — PostSync self-healing for Istio race condition (see [ADR-0011](docs/adr/0011-kuadrant-istio-race-condition.md))
